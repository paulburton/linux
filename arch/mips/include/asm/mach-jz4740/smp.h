...
#ifndef __ARCH_MIPS_INGENIC_SMP_H__
#define __ARCH_MIPS_INGENIC_SMP_H__
...
static inline void ingenic_smp_init(void) { }

#endif /* !CONFIG_SMP */

#endif /* __ARCH_MIPS_INGENIC_SMP_H__ */
